	<?php /*Template Name: portaria_terapia_ocupacional*/?>
	<?php get_header(); ?>
	...
	<section>
		...
		$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
		 query_posts("category_name=portto&posts_per_page=20&paged=".$paged);

		 ?>
		<div class="principalArtigo artigo row">
			<?php
				    // Get the ID of a given category
				   	$category_portto = get_category_by_slug("portto")->cat_ID;

				    // Get the URL of this category
 				   $category_link_portto = get_category_link( $category_portto );

 				   $category_link_porttoPage = get_page_link(19);
			?>

<!-- Print a link to this category -->

			<h2>Portarias - Terapia Ocupacional</h2>
			<article>
