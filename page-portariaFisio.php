	<?php /*Template Name: portaria_fisioterapia*/?>
	<?php get_header(); ?>
	...
	<section>
		...
		$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
		 query_posts("category_name=portfisio&posts_per_page=20&paged=".$paged);

		 ?>
		<div class="principalArtigo artigo row">
			<?php
				    // Get the ID of a given category
				   	$category_portfisio = get_category_by_slug("portfisio")->cat_ID;

				    // Get the URL of this category
 				   $category_link_portfisio = get_category_link( $category_portfisio );

 				   $category_link_portfisioPage = get_page_link(19);
			?>

<!-- Print a link to this category -->

			<h2>Portarias - Fisioterapia</h2>
			<article>
